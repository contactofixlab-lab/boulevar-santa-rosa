...
const stats = [
  ...
  { iconName: "departamentos",   value: "95", label: "Departamentos",     iconColor: "#84CE25", bgGradient: "rgba(132, 206, 37, 0.08)" },
  { iconName: "estacionamiento", value: "61", label: "Estacionamientos",  iconColor: "#0671AE", bgGradient: "rgba(6, 113, 174, 0.08)" },
  { iconName: "bodegas",         value: "68", label: "Bodegas",           iconColor: "#84CE25", bgGradient: "rgba(132, 206, 37, 0.08)" },
  ...
  return (
    <section className="relative z-20 pb-6 md:pb-10" style={{ perspective: "1000px" }}>
      <div className="max-w-7xl mx-auto px-6">
        {/* Mobile Carousel */}
        <div className="md:hidden flex flex-col items-center -mx-6">
          <div className="overflow-hidden w-screen px-6" ref={emblaRef}>
            <div className="flex gap-3">
              {stats.map((stat, idx) => (
                <div key={stat.label} className="flex-shrink-0 w-[calc(100vw-48px)] flex justify-center">
