      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-[0.75fr_1.25fr] gap-12 items-start">
          ...
          >
            ...
            {/* Puntos de interés - Solo UN ícono por ubicación */}
            ...
            <div className="absolute flex items-center gap-2 bg-white rounded-lg px-2 py-1.5 shadow-lg border border-[#0671AE]" style={{ left: "65%", top: "28%", transform: "translate(-50%, -50%)" }}>
